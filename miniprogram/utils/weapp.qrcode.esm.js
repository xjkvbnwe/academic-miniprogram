...
function drawQrcode(t, e) {
  if (t = t || {}, (t = extend(!0, {
    ...
    if (t.paddingColor || (t.paddingColor = t.background), e) {
      ...
      return r.addData(utf16to8(t.text)), r.make(), new Promise(function (t, e) {
        t(r)
      })
    }
    return new Promise(function (e, r) {
      return e(function () {
        ...
        for (var a = (i - 2 * t.padding) / e.getModuleCount(), s = (i - 2 * t.padding) / e.getModuleCount(), u = 0; u < e.getModuleCount(); u++)
        ...
        if (t.image.imageResource) {
          ...
          if (t.image.round) {
            const o = t.image.width * r + 30,
              ...
              l = o / 2,
              h = u + l;
            n.beginPath(), n.arc(h, h, l, 0, 2 * Math.PI), n.fillStyle = "#ffffff", n.fill(), n.restore();
            const f = e / 2,
              g = a + f,
              c = s + f;
            n.beginPath(), n.arc(g, c, f, 0, 2 * Math.PI), n.clip(), n.drawImage(t.image.imageResource, a, s, e, e), n.restore()
